...
import 'package:flutter_project_1st/chatbot/chatbot.dart';
import 'package:flutter_project_1st/generated/l10n.dart';
import 'package:flutter_project_1st/getStarted.dart';
import 'package:flutter_project_1st/helpPage/helpmain.dart';
import 'package:flutter_project_1st/homepage/mainpage.dart';
import 'package:flutter_project_1st/ipaddress.dart';
import 'package:flutter_project_1st/loyalty_points/loyalty_poinys.dart';
...
class _HiddenDrawerState extends State<HiddenDrawer> {
  ...
  void initState() {
    ...
    _pages = [
      ...
      ScreenHiddenDrawer(
          ItemHiddenMenu(
            name: Intl.getCurrentLocale() == 'ar' ? "شات بوت" : "chatBot",
            baseStyle: TextStyle(
                color:
                    themeProvider.isDarkMode ? Colors.black : Color(0xFFffffff),
                fontWeight: FontWeight.bold,
  ...
  Future<void> initializeData() async {
    try {
      ...
      paymentArray = await paymentSuccessful(itemOwner.toString());
      print('reservedArray: $reservedArray');
      print('resultReservedArray: $resultReservedArray');
      print('paymentArray: $paymentArray');
  ...
  Future<List<Map<String, dynamic>>> paymentSuccessful(
      String purchaserId) async {
    final ipAddress = await getLocalIPv4Address();
    final String apiUrl =
        "http://$ipAddress:3000/paymentSuccessful/$purchaserId";
