...
import 'package:flutter_project_1st/categorise/homemadeCooking/homeMadeCooking.dart';
...
class _CategoriesSectionState extends State<CategoriesSection> {
  List<Map> categories = [
    ...
    {
      "name":
          Intl.getCurrentLocale() == 'ar' ? "طهي منزلي" : "Homemade Cooking",
  ...
  void navigateToCategoryPage(BuildContext context, int index, int registerID) {
    ...
    } else if (categories[index]['name'] == 'Homemade Cooking' ||
        categories[index]['name'] == 'طهي منزلي') {
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) =>
              homeMadeCookingMain(index: 4, registerid: registerID),
        ),
      );
    }
  }
