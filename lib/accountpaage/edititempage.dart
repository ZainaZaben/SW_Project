        ...
        child: GestureDetector(
          ...
          child: ListView(
            children: [
              ...
              buildTextField(S.of(context).title, widget.itemTitle,
                  titleController, themeProvider),
              buildTextField(S.of(context).price, widget.itemPrice,
                  priceController, themeProvider),
              buildTextField(S.of(context).Status, widget.itemStatus,
                  statusController, themeProvider),
