...
import 'package:flutter_project_1st/payment/paymentSlides.dart';
                                ...
                                onTap: () {
                                  ...
                                  if (widget.isFree) {
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                PaymentSlidesScreen(RegisterID:registerID.toString() ,itemId:widget.itemId.toString(),itemname:widget.title ,pdfFilePath:widget.pdfFilePath ,price:widget.price,mealName: "",ismeal: "0",)));
                                  }
                                },
                              ),
                            ),
