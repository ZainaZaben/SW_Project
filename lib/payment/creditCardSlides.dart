...
class CreditCardSlidesScreen extends StatefulWidget {
  const CreditCardSlidesScreen(
      {Key? key,
  ...
  @override
  State<CreditCardSlidesScreen> createState() => _CreditCardSlidesScreenState();
}

class _CreditCardSlidesScreenState extends State<CreditCardSlidesScreen> {
  String cardNumber = '';
  String expiryDate = '';
